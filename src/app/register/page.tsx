...
export const metadata: Metadata = {
  ...
  keywords: ['registro restaurante', 'crear cuenta', 'carta alérgenos', 'software hostelería', 'Alergenu'],

  // Para WhatsApp, Facebook, etc. (Open Graph)
  openGraph: {
    title: 'Regístrate y crea gratis tu carta | ALERGENU',
    description: 'Digitaliza tu carta y cumple con la normativa de alérgenos fácilmente.',
    url: 'https://www.alergenu.com/register', // Asegúrate de que esta es tu URL de producción
    siteName: 'Alergenu',
    images: [
      {
