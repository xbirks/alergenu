  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-6 pb-20">
        ...
        <section className="w-full max-w-xs md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto mt-20 container">
          <ul className="space-y-10 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 md:gap-y-10 md:space-y-0">
        ...
        <section className="w-full max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto mt-28 container px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">Filtrado automático de los alérgenos en tiempo real.</h3>
              </div>
              <div className="pt-6">
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">Cumplimiento con la normativa europea de alérgenos.</h3>
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">Selecciona los alérgenos en tu menú del día con <span style={{ color: '#2563EB' }}><strong>IA</strong></span> para ahorrar tiempo.</h3>
            </div>
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">Registro histórico de cada cambio de tus platos en PDF.</h3>
            </div>
            ...
            <div className="py-6 pr-6 pl-4 rounded-2xl border">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold tracking-tight leading-tight">Traducción automática al inglés de todos los platos de tu carta.</h3>
            </div>
          </div>
        </section>

        <section className="w-full max-w-2xl lg:max-w-4xl mx-auto mt-16 text-left container px-4">
        ...
        <section className="w-full max-w-4xl xl:max-w-6xl mx-auto mt-24 px-4">
          {/* Cabecera */}
          ...
          {/* Pasos - Carousel en mobile, Grid en desktop */}
          <div className="lg:grid lg:grid-cols-3 lg:gap-6 lg:space-y-0">
            {/* Mobile: Horizontal scroll container */}
            <div ref={carouselRef} className="lg:hidden flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 -mx-4 px-4 scrollbar-hide">
              {/* Paso 1 */}
              <div className="flex-shrink-0 w-[85vw] max-w-sm snap-center rounded-2xl border border-gray-200 bg-white p-6">
                {/* Imagen paso 1 */}
                <div className="mb-4 w-full h-48 relative rounded-xl overflow-hidden bg-gray-100">
                  <Image
                    src="/assets/recursos/paso1.jpg"
                    alt="Sube tu carta"
                    fill
                ...
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-[17px] text-gray-700 leading-relaxed">
              ...
              <div className="flex-shrink-0 w-[85vw] max-w-sm snap-center rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="mb-4 w-full h-48 relative rounded-xl overflow-hidden bg-gray-100">
                  <Image
                    src="/assets/recursos/paso2.jpg"
                    alt="Gestiona el menú del día con IA"
                    fill
                    className="object-cover"
                  />
                </div>
              ...
              <div className="flex-shrink-0 w-[85vw] max-w-sm snap-center rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="mb-4 w-full h-48 relative rounded-xl overflow-hidden bg-gray-100">
                  <Image
                    src="/assets/recursos/paso3.jpg"
                    alt="Tus clientes filtran y tú quedas protegido"
                    fill
                    className="object-cover"
                  />
                </div>
            ...
            <div className="hidden lg:contents">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-7">
                {/* Imagen paso 1 */}
                <div className="mb-6 w-full h-48 relative rounded-xl overflow-hidden bg-gray-100">
                  <Image
                    src="/assets/recursos/paso1.jpg"
                    alt="Sube tu carta"
                    fill
        ...
        <section className="w-full max-w-2xl lg:max-w-5xl xl:max-w-6xl mx-auto mt-28 container px-4">
          <div className="text-left mb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <div className="relative aspect-[4/3]">
                <Image src="/assets/restaurante_02.jpeg" alt="Interior de un restaurante elegante" layout="fill" objectFit="cover" />
              </div>
            </div>
          </div>
        ...
        {/* Pricing Section */}
        <section id="precios" className="w-full max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto mt-28 container px-4">
          <div className="text-left mb-12">
